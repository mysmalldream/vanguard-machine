;(function (exports) {
    var KeyBoard = function (input, options) {
        ...
        if (!mobile) {
            cssStr += "#" + TABLE_ID + " td:hover{background-color:#E38F5F;color:#FFF;}";
        }
        cssStr += '</style>';
        ...
        tableStr += '<tr><td style="background-color:#EFBDAC">删除</td><td>0</td>';;
        tableStr += '<td style="background-color:#EFBDAC;">确定</td></tr>';
        tableStr += '</table>';
        ...
        function addEvent(e) {
            ...
            if (clickEl.tagName.toLocaleLowerCase() === 'td' && value !== "删除" && value !== "确定") {
                if (self.input) {
